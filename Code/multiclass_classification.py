...
def run_experiment(train_images, train_labels, test_images, test_labels, learning_algo):
    ...
    print("Training Time: %.2f seconds" % (time.process_time() - start_time))
    print("Weights Learned!")

    print("Classifying Test Images ...")
    start_time = time.process_time()
    predicted_labels = predict(all_weights, test_images, learning_algo)
    print("Prediction Time: %.2f seconds" % (time.process_time() - start_time))
...
def main():
    # load data
    data = MNIST('C:/Users/91934/Downloads/Handwritten-Digits-Classification-Using-KNN-Multiclass_Perceptron-SVM-master/Handwritten-Digits-Classification-Using-KNN-Multiclass_Perceptron-SVM-master/Code/samples')
